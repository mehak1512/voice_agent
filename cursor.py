...
async def text_to_speech(speech: str):
    async with async_client.audio.speech.with_streaming_response.create(
        ...
        voice="fable",
        instructions="Always speak in a delighted and calm manner " ,
        input=speech,
        response_format="pcm",
    ) as response:
...
with sr.Microphone() as source:
    ...
    while True:
        ...
        print("Processing audio and converting speech to text....")
        ...
        while True:
            ...
            if parsed_result.step == "OUTPUT":
                print("🤖", parsed_result.content)
                asyncio.run(text_to_speech(speech=parsed_result.content))
                break